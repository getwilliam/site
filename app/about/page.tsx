      ...
      <div className="relative max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-12">
            <span className="text-blue-400 font-medium uppercase tracking-wider text-sm">Leadership</span>
            <h2 className="text-3xl md:text-4xl font-bold font-display mt-4">Meet Our Founder</h2>
          </motion.div>
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div className="flex-shrink-0">
                  <div className="relative">
                    <div className="w-48 h-48 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center overflow-hidden">
                      ...
                      {/* <span className="text-6xl font-bold text-white/90">JJ</span> */}
                    </div>
                    <div className="absolute -inset-2 rounded-2xl bg-blue-500/20 blur-xl -z-10" />
                  </div>
                </div>

                <div className="text-center md:text-left">
                  <h3 className="text-3xl font-bold font-display mb-2">Jessica Jonas</h3>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-[#0A66C2] text-white rounded-full font-medium hover:bg-[#0A66C2]/80 transition-colors"
                  >
        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold font-display mb-8">Our Story</h2>
            <div className="space-y-6 text-zinc-300 text-lg">
              ...
              <p>
                Studies show that attorneys lose an average of 2+ hours per day to billing inefficiencies—time that should be spent serving clients. That&apos;s nearly millions of dollars in lost revenue per year.
              </p>
              <p>
        ...
        >
          <div className="glass rounded-2xl p-12">
            <h2 className="text-3xl font-bold font-display mb-4">Ready to Transform Your Billing?</h2>
