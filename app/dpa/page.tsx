  ...
  return (
    <main className="min-h-screen bg-[#0A0A0F] relative noise-overlay overflow-x-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-5 sm:px-6 py-8 sm:py-12">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display mb-4">Data Processing Agreement</h1>
          ...
          <div className="space-y-6 sm:space-y-8 text-zinc-300 text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">2. Definitions</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">3. Scope and Roles</h2>
              
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">3.1 Customer as Controller</h3>
              <p>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">3.2 William as Processor</h3>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">4. Data Processing Details</h2>
              
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">4.1 Subject Matter</h3>
              <p>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">4.2 Duration</h3>
              <p>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">4.3 Categories of Data Subjects</h3>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">4.4 Types of Personal Data</h3>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">5. William&apos;s Obligations</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">6. Sub-processors</h2>
              
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">6.1 Authorization</h3>
              <p>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">6.2 Sub-processor Requirements</h3>
              <p>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mt-6 mb-3">6.3 Notice of Changes</h3>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">7. Security Measures</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">8. Security Incidents</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">9. International Data Transfers</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">10. Data Subject Rights</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">11. Data Retention and Deletion</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">12. Audits</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">13. Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">14. Contact</h2>
              <p>
